...
ok( $e0->{ellipsoid} eq 'EVEREST-1830' );
ok( $e0->{units} eq 'degrees' );
delta_ok( $e0->{equatorial}, 6377276.345 );
delta_ok( $e0->{polar}, 6356075.41314024 );
delta_ok( $e0->{flattening}, 0.00332444929666288 );
...
ok( $e1->{ellipsoid} eq 'HOUGH-1956' );
ok( $e1->{units} eq 'degrees' );
delta_ok( $e1->{equatorial}, 6378270 );
delta_ok( $e1->{polar}, 6356794.34343434 );
delta_ok( $e1->{flattening}, 0.00336700336700337 );
...
ok( $e2->{ellipsoid} eq 'HAYFORD' );
ok( $e2->{units} eq 'degrees' );
delta_ok( $e2->{equatorial}, 6378388 );
delta_ok( $e2->{polar}, 6356911.94612795 );
delta_ok( $e2->{flattening}, 0.00336700336700337 );
...
ok( $e3->{ellipsoid} eq 'AIRY-MODIFIED' );
ok( $e3->{units} eq 'degrees' );
delta_ok( $e3->{equatorial}, 6377340.189 );
delta_ok( $e3->{polar}, 6356034.44793853 );
...
ok( $e4->{ellipsoid} eq 'NWL-9D' );
ok( $e4->{units} eq 'degrees' );
delta_ok( $e4->{equatorial}, 6378145 );
delta_ok( $e4->{polar}, 6356759.76948868 );
delta_ok( $e4->{flattening}, 0.00335289186923722 );
...
ok( $e6->{ellipsoid} eq 'KRASSOVSKY-1938' );
ok( $e6->{units} eq 'degrees' );
delta_ok( $e6->{equatorial}, 6378245 );
delta_ok( $e6->{polar}, 6356863.01877305 );
delta_ok( $e6->{flattening}, 0.00335232986925913 );
...
ok( $e7->{ellipsoid} eq 'FISHER-1968' );
ok( $e7->{units} eq 'degrees' );
delta_ok( $e7->{equatorial}, 6378150 );
delta_ok( $e7->{polar}, 6356768.33724438 );
...
ok( $e8->{ellipsoid} eq 'AUSTRALIAN' );
ok( $e8->{units} eq 'degrees' );
delta_ok( $e8->{equatorial}, 6378160 );
delta_ok( $e8->{polar}, 6356774.71919531 );
delta_ok( $e8->{flattening}, 0.00335289186923722 );
...
ok( $e9->{ellipsoid} eq 'EVEREST-MODIFIED' );
...
ok( $e10->{ellipsoid} eq 'WGS72' );
ok( $e10->{units} eq 'degrees' );
delta_ok( $e10->{equatorial}, 6378135 );
delta_ok( $e10->{polar}, 6356750.52001609 );
delta_ok( $e10->{flattening}, 0.0033527794541675 );
...
ok( $e11->{ellipsoid} eq 'FISHER-1960' );
ok( $e11->{units} eq 'degrees' );
delta_ok( $e11->{equatorial}, 6378166 );
delta_ok( $e11->{polar}, 6356784.28360711 );
...
ok( $e13->{ellipsoid} eq 'AIRY' );
ok( $e13->{units} eq 'degrees' );
delta_ok( $e13->{equatorial}, 6377563.396 );
delta_ok( $e13->{polar}, 6356256.90923729 );
delta_ok( $e13->{flattening}, 0.00334085064149708 );
...
ok( $e14->{ellipsoid} eq 'GRS80' );
ok( $e14->{units} eq 'degrees' );
delta_ok( $e14->{equatorial}, 6378137 );
delta_ok( $e14->{polar}, 6356752.31414035 );
delta_ok( $e14->{flattening}, 0.00335281068118367 );
...
ok( $e19->{ellipsoid} eq 'NAD27' );
ok( $e19->{units} eq 'degrees' );
delta_ok( $e19->{equatorial}, 6378206.4 );
delta_ok( $e19->{polar}, 6356583.79999999 );
delta_ok( $e19->{flattening}, 0.00339007530392992 );
